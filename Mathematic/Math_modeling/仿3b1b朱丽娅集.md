...
我还在许久之前，这个博客上做过一些其他的 http://localhost:4000/posts/ebf347fe.html
...
void main(){
  float x = mix(-1.3,1.3,(vPos.x+1.0)/2.0);
  float y = mix(-1.3,1.3,(vPos.y+1.0)/2.0);
...
function updatePosition(e) {
  ...
  currentX = Math.max(0, Math.min(600, e.offsetX / canvas.clientWidth * 600));
  currentY = Math.max(0, Math.min(600, e.offsetY / canvas.clientHeight * 600));
  updateYellowPoint();
}
